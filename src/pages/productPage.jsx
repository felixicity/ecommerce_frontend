...
import { increaseAmount, decreaseAmount} from '../features/product/productSlice'
...
const ProductPage = () => {
    ...
    return (
        ...
        <div className='product-page wrapper'>
            <img src={product[0].img} alt={product[0].title} className="product-img"/>
            <div>
                ...
                <div className='item-quantity'>
                    <div className="subtract" onClick = {() => amount > 0 && dispatch(decreaseAmount(product[0].id))}>-</div>
                    <div className="quantity">{amount}</div>
                    <div className="add"  onClick = {() => dispatch(increaseAmount())}>+</div>
                </div>
                
                <button className='addCart-btn' onClick={()=> dispatch(addItem(product[0].id))}>Add to Cart</button>
